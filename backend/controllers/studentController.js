  ...
  try {
    ...
    Courses.findCourse(
      ...
      function (err, docs2) {
        ...
        var action_string = "Successfully Registered " + student.username;
  ...
  if (student.registered_course.length == 0) {
    ...
    Courses.findCourse(
      ...
      function (err, docs2) {
        ...
        if (student.registered_course.length != 0) student.has_opted = true;
        student.save();
...
const displaycourses = async (req, res) => {
  ...
  Courses.findCourse("courses", {}, function (err, docs2) {
    res
      .status(200)
      .json(docs2.sort((a, b) => (a.semester > b.semester ? 1 : -1)));
  });
};
