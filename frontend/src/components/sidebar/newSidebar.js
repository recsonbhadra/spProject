  ...
  if (hasAuth)
    return (
      <ProSidebar collapsed={menuCollapse}>
        <h4 className="pl-1 pt-3">RECSonbhadra</h4>
        <Menu iconShape="square">
          ...
          <MenuItem icon={<i className="bi bi-person-lines-fill p-2"></i>}>
            <Link
          ...
          <MenuItem icon={<i className="bi bi-clipboard-check p-2"></i>}>
            <Link
          ...
          <MenuItem icon={<i className="bi bi-file-earmark-text p-2"></i>}>
          ...
          <MenuItem icon={<i className="bi bi-calendar-date p-2"></i>}>
            <a
              className="nav-link sidebar-link"
              href={data.cal}
              target="_blank"
