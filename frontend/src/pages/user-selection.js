  ...
  return (
    <div className="selectUser container p-0">
      <nav class="navbar navbar-expand-lg homepage-navbar p-0">
        <div class="navbar-brand ml-3">RECSonbhadra</div>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mr-1">
              <Link class="nav-link homepage-link" to="/adminLogin">
                <button
                  type="button"
                  class="btn rounded-pill homepage-link-pill m-0"
                >
      ...
      <div className="row vw-100 m-0 mt-2 p-0">
        ...
        <div className="col m-0 text-right pt-5">
          <div className="welcome mt-5  pr-4">RECSonbhadra Student Portal</div>
          <div className="welcome-text mt-2  pr-4">
            A web portal to keep track of all the information related to the
            academic courses of the students. A place for students to see their
            marks, attendance and other academic records and request for
