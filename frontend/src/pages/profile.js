      ...
      <div className="card col-md-6 mx-auto profile-card shadow">
        <div className="card-body">
          <img
            ...
            alt=""
          />
          <h2 className="card-title pb-3">Rohit Pal</h2>
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item p-0 m-2 border">
              ...
              <span className="profile-data-list float-right p-2">CSE</span>
            </li>
            <li class="list-group-item p-0 m-2 border">
              <span
                class="details-text float-left p-2 m-0"
              ...
              <span className="profile-data-list float-right p-2">8</span>
            </li>
            <li class="list-group-item p-0 m-2 border">
              <span
                class="details-text float-left p-2 m-0"
            ...
            <li class="list-group-item p-0 m-2 border">
              ...
              <span className="profile-data-list float-right p-2">A</span>
            </li>
